...
opts.add_option("-d", help="<OutDir> Output directory storing the trimmed files")
...
#================
# output files are placed within the specified output directory
p1_out = OutDir + '/' + p1_out
p2_out = OutDir + '/' + p2_out
#=================
